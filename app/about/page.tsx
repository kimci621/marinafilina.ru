    ...
    <>
      ...
      <main className="pt-[80px]">
        <section className="content-container py-[60px]">
          ...
          <p className="text-subtitle-mobile tablet:text-subtitle-tablet desktop:text-subtitle-desktop">
            {about.headline}
          </p>
        </section>
        ...
        <section className="content-container py-[60px]">
          <div className="grid grid-cols-1 tablet:grid-cols-3 gap-[30px]">
            {about.services.map((service, i) => (
              <div key={i}>
                <h3 className="text-subtitle-tablet desktop:text-subtitle-desktop mb-[12px]">
                  {service.title}
                </h3>
